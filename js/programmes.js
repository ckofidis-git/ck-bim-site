...
(function () {
  const DATA = {
    terminal: {
      ...
      intro: "Senior BIM Manager owning the information-management function on a major international aviation megaproject — standing up the ISO 19650 framework, the common data environment and the model-production workflows the delivery teams run on.",
      contributions: [
        "Authored the full ISO 19650 deliverable suite — EIR, MIDP/TIDP, Level of Information Need matrix, model-element catalogue, federation strategy and clash matrix — so every discipline shares one standards-compliant definition of what to produce, to what fidelity, and when.",
        "Implemented and configured a model-based common data environment aligned to ISO 19650, with a reusable project template for folder structure, role-based permissions and review/approval workflows.",
        "Set up clash detection and cross-discipline coordination cycles through a federation strategy and clash-matrix reporting templates.",
        "Drove classification and attribute automation so engineers auto-classify objects and enforce correct data in Civil 3D and Revit, with rule-based model-data checking.",
        "Stood up a no-code, API-connected delivery planning-and-tracking solution integrated with the CDE — replacing siloed spreadsheets with near-real-time planned-vs-actual KPIs.",
        "Authored configuration and user guides, workflow diagrams and a training-video library, and ran live sessions to drive adoption.",
      ],
      achievements: [
        "Information-management templates and CDE setup targeted a 25–30% reduction in rework with faster, standardised project start-up.",
        "Classification and attribution automation cut manual data-capture effort by up to ~4 weeks per project while removing human error.",
        "Delivered centralised, auditable visibility of model completeness across the programme.",
      ],
    },
    linecity: {
